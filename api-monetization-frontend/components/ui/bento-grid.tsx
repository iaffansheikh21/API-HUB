...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 bg-white border border-gray-200 justify-between flex flex-col space-y-4",
        className,
      )}
    >
      {header}
